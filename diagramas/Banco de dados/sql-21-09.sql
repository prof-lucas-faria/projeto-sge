...
CREATE TABLE IF NOT EXISTS `sge`.`trabalho` (
  ...
  INDEX `fk_trabalho_usuario1_idx` (`apresentador` ASC),
...
-- -----------------------------------------------------
-- Table `sge`.`trabalho_has_tipo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge`.`trabalho_has_tipo` (
  `trabalho_id` INT NOT NULL,
  `tipo_id` INT NOT NULL,
  PRIMARY KEY (`trabalho_id`, `tipo_id`),
  INDEX `fk_trabalho_has_tipo_tipo1_idx` (`tipo_id` ASC),
  INDEX `fk_trabalho_has_tipo_trabalho1_idx` (`trabalho_id` ASC),
