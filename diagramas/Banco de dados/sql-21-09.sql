...
CREATE TABLE IF NOT EXISTS `sge`.`evento_has_tipo` (
  ...
  `tipo_tipo_id` INT NOT NULL,
  PRIMARY KEY (`evento_evento_id`, `tipo_tipo_id`),
  INDEX `fk_evento_has_tipo_tipo1_idx` (`tipo_tipo_id` ASC),
  INDEX `fk_evento_has_tipo_evento1_idx` (`evento_evento_id` ASC),
