...
$lista_assistentes = $usuarios->listarAssistentes($evento_id);
            ...
            <?php if (count($lista_assistentes) > 0) { ?>
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="col" width="10%">Assistente</th>
                    </tr>
                    </thead>
                    <tbody>

                    <?php foreach ($lista_assistentes as $i => $usuario) { ?>
                ...
                <div class="row d-flex justify-content-end pr-3 pl-3">
                    <button id="atualiza_permissao_assistente"
...
$footer->setJS('../admin/assets/js/listagem_assistentes.js');
